...
- Sample: Mice that died while not on the treatment
- Sample size: 261
...
```{r practice_2_ci}
mice_practice2_ci <- get_ci(mice_practice2, level = .9)
mice_practice2_ci
```
...
visualise(mice_practice2) +
  shade_ci(mice_practice2_ci)
```

Give an interpretation of your result.
We are 90% confident that the proportion of mice that survived while on the treatment is between 55.2% and 65.1%.
